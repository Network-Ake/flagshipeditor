@echo off
rem FlagshipEditor 2.0.0 - bridge from the CEP panel to the installed backend.
rem
...
echo ERROR 60: FlagshipEditor is not installed. Run FlagshipEditor-2.0.0-Windows.msi again.
exit /b 60
