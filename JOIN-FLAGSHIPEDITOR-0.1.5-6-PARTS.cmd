...
set "OUTPUT=FlagshipEditor-0.1.5-Windows.zip"
set "EXPECTED=169a73e062ab73d879b0542bff0eb60fa47ca4761a35b822f91fc0a7e2ad9a7b"
set "ACTUAL="

echo FlagshipEditor 0.1.5 - verified six-part joiner
echo No PowerShell. The output is rejected if one byte is wrong.
echo.

for %%F in (
  "FlagshipEditor-0.1.5-Windows.zip.part01"
  "FlagshipEditor-0.1.5-Windows.zip.part02"
  "FlagshipEditor-0.1.5-Windows.zip.part03"
  "FlagshipEditor-0.1.5-Windows.zip.part04"
  "FlagshipEditor-0.1.5-Windows.zip.part05"
  "FlagshipEditor-0.1.5-Windows.zip.part06"
) do if not exist "%%~F" (
...
copy /b /y "FlagshipEditor-0.1.5-Windows.zip.part01"+"FlagshipEditor-0.1.5-Windows.zip.part02"+"FlagshipEditor-0.1.5-Windows.zip.part03"+"FlagshipEditor-0.1.5-Windows.zip.part04"+"FlagshipEditor-0.1.5-Windows.zip.part05"+"FlagshipEditor-0.1.5-Windows.zip.part06" "%OUTPUT%" >nul || (
