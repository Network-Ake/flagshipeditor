...
- Verdict: **WARN**
- Exit code: `2`
- Generated: `2026-08-25T14:13:38+00:00`
- Protocol: `1.0.0`
...
- **PASS** `required-symbols` — engine/beat_analysis.py exposes every required contract symbol
  - `engine/beat_analysis.py:277 analyze_track`
  - `engine/beat_analysis.py:778 detect_phrase_boundaries`
...
- **WARN** `B06` — Energy samples are emitted without their calculated time base
  - `engine/beat_analysis.py:361 rms_times is calculated`
  - `engine/beat_analysis.py:413 result emits energy only`
- **WARN** `B09` — Musical labels remain heuristic and carry no confidence/provenance
  - `engine/beat_analysis.py:320 every fourth beat is labelled downbeat`
  - `engine/beat_analysis.py:547 first section is forced to intro`
  - `engine/beat_analysis.py:548 last section is forced to outro`
...
- Status: **drift**
- Changed: `engine/beat_analysis.py` — expected `cd7d805b9fd819bd2afee3f1cd7fec6519b58b7dabc3f72deaea52252f554608`, actual `e17a3bbd1d16ab7232af24e61849262db9d940a688ab809bfb29d2076b7b7f51`
...
- Changed: `scripts/test-engine-contracts.py` — expected `521a572a6dc457389e281234a246f7d920905bcc16b5e985ccae30a3fb28d356`, actual `72a8d69c143350a5bdd84101cb149e25a7bdd168fcfbbeecac2445cf3c241dad`
...
- `engine/beat_analysis.py` — `e17a3bbd1d16ab7232af24e61849262db9d940a688ab809bfb29d2076b7b7f51` (30436 bytes)
