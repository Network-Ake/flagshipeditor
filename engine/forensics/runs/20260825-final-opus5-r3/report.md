...
- Verdict: **WARN**
- Exit code: `2`
- Generated: `2026-08-25T23:47:31+00:00`
- Protocol: `1.0.0`
...
- **PASS** `required-symbols` — engine/clip_analysis.py exposes every required contract symbol
  ...
  - `engine/clip_analysis.py:1435 classify_clip`
  - `engine/clip_analysis.py:1396 compute_visual_scores`
  - `engine/clip_analysis.py:1114 find_best_moment`
...
- **PASS** `required-symbols` — engine/shot_selector.py exposes every required contract symbol
  ...
  - `engine/shot_selector.py:1139 plan_cuts`
  - `engine/shot_selector.py:548 score_clip`
  - `engine/shot_selector.py:1534 select_best_clips`
...
- **PASS** `S13` — Selector best-moment source window reaches and is applied by After Effects
  - `engine/shot_selector.py:1756 selector emits sourceStart`
...
- Status: **drift**
- Changed: `engine/beat_analysis.py` — expected `cd7d805b9fd819bd2afee3f1cd7fec6519b58b7dabc3f72deaea52252f554608`, actual `6d51acff31849302d86c57b28f8ccd4bca88b148e6ec2b2786d62c532d58e754`
- Changed: `engine/clip_analysis.py` — expected `e2c80f512a6fff8ba504f3e1f664b281f36c63b8f107557130c1c336055e4551`, actual `fdda83cb62a49417288cd757c93c0a46a746eb3f8e6ca368c98a4562c6da6593`
- Changed: `engine/shot_selector.py` — expected `59d8100caeeb3cf6c464d7b8bbcc34de897fe59434a29d13632269a9188fd9f3`, actual `36007d36fbb6a4bfb20149d4deb4b019e1eb294dc4bd731990422998776ca56f`
- Changed: `scripts/cyber_forensic_protocol.py` — expected `44084a4e923ea425011134f1d016357fd0f129ddeebeec437933263d0ed58ab0`, actual `e7dab93cfcc579fc755da99ba8ea7e63db7f2b5411120a8ad11ca2709d8c1ac1`
- Changed: `scripts/test-engine-contracts.py` — expected `521a572a6dc457389e281234a246f7d920905bcc16b5e985ccae30a3fb28d356`, actual `fc1d54aa0ee9b889cb9ce0af9f8a2f5b342c8fa5e4e1d038befa53b9250d93f5`
...
- Changed: `src/js/main/lib/python.ts` — expected `3e14d062ecbca3b392521a107bf11b277a6173e1018482e781ad5beab284e8c7`, actual `fb26abfc07d4688dce9d003c8f1ef3d13a9c4cea89f79e12c8431765501b635f`
...
- Contract fingerprint changed: `f06eb01a8b71e63238318532307a8588670da201692dcfbd4bf833e8bff8c616` → `4669a878e9104b45cb478ac1db8c10934ef7df471c23661f2ae3cbe5a4b4a91b`

## Engine SHA-256

- `engine/beat_analysis.py` — `6d51acff31849302d86c57b28f8ccd4bca88b148e6ec2b2786d62c532d58e754` (49503 bytes)
- `engine/clip_analysis.py` — `fdda83cb62a49417288cd757c93c0a46a746eb3f8e6ca368c98a4562c6da6593` (65993 bytes)
- `engine/shot_selector.py` — `36007d36fbb6a4bfb20149d4deb4b019e1eb294dc4bd731990422998776ca56f` (73185 bytes)
