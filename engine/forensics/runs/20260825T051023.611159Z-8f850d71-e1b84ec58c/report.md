...
- Verdict: **FAIL**
- Exit code: `1`
- Generated: `2026-08-25T05:10:31+00:00`
- Protocol: `1.0.0`
...
- Static/cross-engine checks: {'pass': 21, 'warn': 16, 'fail': 2}
...
- **PASS** `required-symbols` — engine/shot_selector.py exposes every required contract symbol
  - `engine/shot_selector.py:26 SECTION_WEIGHTS`
  - `engine/shot_selector.py:88 SECTION_SCENE_AFFINITY`
  - `engine/shot_selector.py:101 MIN_CUT_SECONDS`
  - `engine/shot_selector.py:656 plan_cuts`
  - `engine/shot_selector.py:210 score_clip`
  - `engine/shot_selector.py:814 select_best_clips`
...
- **WARN** `S12` — Final cuts do not record boundary/onset/grid provenance after arbitration
  - `engine/shot_selector.py:723 slot output fields`
- **FAIL** `S13` — Selector sourceStart/sourceEnd are dropped before rendering; best moment is not applied
  - `engine/shot_selector.py:920 selector emits sourceStart`
...
- **FAIL** `S04-DUPLICATE-IDENTITY` — Selector silently accepts duplicate clip paths and corrupts identity accounting
  - `input_count=9`
  - `unique_paths=8`
  - `output_count=27`
...
- **PASS** `engine-contracts` — exit=0, stdout_sha256=`d7175400a9b106f56aa8384ab4e0d58b2542b440a513a754b5c648e0b5d53954`, stderr_sha256=`e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855`
...
- `engine/shot_selector.py` — `cbb915d9c7785036db19d30dfebc85f0a174c54153d5291da068e30dd79d5036` (37752 bytes)
