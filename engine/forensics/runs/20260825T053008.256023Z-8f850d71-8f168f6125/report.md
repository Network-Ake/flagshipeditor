...
- Verdict: **WARN**
- Exit code: `2`
- Generated: `2026-08-25T05:30:12+00:00`
- Protocol: `1.0.0`
...
- Static/cross-engine checks: {'pass': 23, 'warn': 16, 'fail': 0}
...
- **PASS** `required-symbols` — engine/shot_selector.py exposes every required contract symbol
  ...
  - `engine/shot_selector.py:712 plan_cuts`
  - `engine/shot_selector.py:266 score_clip`
  - `engine/shot_selector.py:870 select_best_clips`
...
- **WARN** `S12` — Final cuts do not record boundary/onset/grid provenance after arbitration
  - `engine/shot_selector.py:779 slot output fields`
- **PASS** `S13` — Selector best-moment source window reaches and is applied by After Effects
  - `engine/shot_selector.py:979 selector emits sourceStart`
  - `src/js/main/lib/python.ts:126 CutDecision source fields=True`
  ...
  - `src/jsx/aeft/aeft.ts:271 renderer source offset applied=True`
...
- `engine/shot_selector.py` — `04535d54ab91019659f1c87b8ae320df8f8f834ebf210be6d062772bf488f1df` (40223 bytes)
