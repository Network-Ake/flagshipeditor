...
set "OUTPUT=FlagshipEditor-0.1.7-Windows.zip"
set "EXPECTED=0df77c985ffc3ec3a54eca22281289d680d11520c05fbce03811974bcdba07dd"
set "ACTUAL="

echo FlagshipEditor 0.1.7 - verified six-part joiner
echo No PowerShell. The output is rejected if one byte is wrong.
echo.

for %%F in (
  "FlagshipEditor-0.1.7-Windows.zip.part01"
  "FlagshipEditor-0.1.7-Windows.zip.part02"
  "FlagshipEditor-0.1.7-Windows.zip.part03"
  "FlagshipEditor-0.1.7-Windows.zip.part04"
  "FlagshipEditor-0.1.7-Windows.zip.part05"
  "FlagshipEditor-0.1.7-Windows.zip.part06"
) do if not exist "%%~F" (
...
copy /b /y "FlagshipEditor-0.1.7-Windows.zip.part01"+"FlagshipEditor-0.1.7-Windows.zip.part02"+"FlagshipEditor-0.1.7-Windows.zip.part03"+"FlagshipEditor-0.1.7-Windows.zip.part04"+"FlagshipEditor-0.1.7-Windows.zip.part05"+"FlagshipEditor-0.1.7-Windows.zip.part06" "%OUTPUT%" >nul || (
